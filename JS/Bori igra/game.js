var i, tochki=0, myY, notaX=[], notaY=[], poslednaNota=0, zlaLiE=[], kobra=new Image();
kobra.src="kobra.jpg"
myY=25
notaX[0]=800;
...
function update() {
    for(i=0;i<5;i+=1){
        notaX[i]-=1;
        if(areColliding(notaX[i], notaY[i], 30, 30, 0, myY, 100, 100)){
            if(zlaLiE[i]){
                tochki-=1;
...
function draw() {
    ...
    context.drawImage(kobra, 0, myY, 100, 100)
